...
**Branch:** `feature/rate-alerts-basket-presets` (forked from `main` @
v1.4.0, not merged). Both items were on the app's public roadmap
("Open ideas: push-based rate alerts...") and requested together in the
